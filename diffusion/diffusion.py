...
def space_timesteps(num_timesteps, section_counts):
    ...
    if isinstance(section_counts, str):
        if section_counts.startswith("ddim") or section_counts.startswith('fdpm'):
...
class SpacedDiffusionBeatGans(GaussianDiffusionBeatGans):
    ...
    # def p_meanvar_tot(self, model: Model, *args, **kwargs):  # pylint: disable=signature-differs
    #     return super().p_meanvar_tot(self._wrap_model(model), *args,
    #                                    **kwargs)
    ...
    # def training_losses_tot(self, model: Model, *args, **kwargs):  # pylint: disable=signature-differs
    #     return super().training_losses_tot(self._wrap_model(model), *args,
    #                                    **kwargs)
...
class _WrappedModel:
    ...
    def forward(self, x, t, r=None, t_cond=None, **kwargs):
        """
        Args:
        ...
        return self.model(x=x, t=do(t), rna=r, t_cond=t_cond, **kwargs)
